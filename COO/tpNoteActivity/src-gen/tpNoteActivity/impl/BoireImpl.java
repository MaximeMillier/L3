...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Boire</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tpNoteActivity.impl.BoireImpl#getControlflow <em>Controlflow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoireImpl extends MinimalEObjectImpl.Container implements Boire {
	/**
	...
	protected EClass eStaticClass() {
		return TpNoteActivityPackage.Literals.BOIRE;
	}
		...
		if (controlflow != null && controlflow.eIsProxy()) {
			...
			if (controlflow != oldControlflow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TpNoteActivityPackage.BOIRE__CONTROLFLOW,
	...
	public void setControlflow(ControlFlow newControlflow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TpNoteActivityPackage.BOIRE__CONTROLFLOW,
					oldControlflow, controlflow));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TpNoteActivityPackage.BOIRE__CONTROLFLOW:
			if (resolve)
