...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Douche</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tpNoteActivity.impl.DoucheImpl#getControlflow <em>Controlflow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoucheImpl extends MinimalEObjectImpl.Container implements Douche {
	/**
	...
	protected EClass eStaticClass() {
		return TpNoteActivityPackage.Literals.DOUCHE;
	}
		...
		if (controlflow != null && controlflow.eIsProxy()) {
			...
			if (controlflow != oldControlflow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TpNoteActivityPackage.DOUCHE__CONTROLFLOW,
	...
	public void setControlflow(ControlFlow newControlflow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TpNoteActivityPackage.DOUCHE__CONTROLFLOW,
					oldControlflow, controlflow));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TpNoteActivityPackage.DOUCHE__CONTROLFLOW:
			if (resolve)
