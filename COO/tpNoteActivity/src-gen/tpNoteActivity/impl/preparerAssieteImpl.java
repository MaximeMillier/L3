...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>preparer Assiete</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tpNoteActivity.impl.preparerAssieteImpl#getControlflow <em>Controlflow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class preparerAssieteImpl extends MinimalEObjectImpl.Container implements preparerAssiete {
	/**
	...
	protected EClass eStaticClass() {
		return TpNoteActivityPackage.Literals.PREPARER_ASSIETE;
	}
			...
			if (controlflow != oldControlflow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TpNoteActivityPackage.PREPARER_ASSIETE__CONTROLFLOW, oldControlflow, controlflow));
			}
		}
		return controlflow;
	}
	...
	public void setControlflow(ControlFlow newControlflow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TpNoteActivityPackage.PREPARER_ASSIETE__CONTROLFLOW,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TpNoteActivityPackage.PREPARER_ASSIETE__CONTROLFLOW:
			if (resolve)
