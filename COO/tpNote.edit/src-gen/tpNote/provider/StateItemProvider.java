...
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_state_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_state_feature", "_UI_State_type"),
						TpNotePackage.Literals.STATE__STATE, true, false, false,
	...
	public String getText(Object object) {
		String label = ((state) object).getState();
	...
	public void notifyChanged(Notification notification) {
		...
		case TpNotePackage.STATE__STATE:
